...
<!-- title -->
@section('title', 'Dietetic Internship Program Application')
<!-- meta title-->
@section('meta_title', 'Dietetic Internship Program Application')
<!-- meta desciption-->
@section('meta_description', 'Dietetic Internship Program Application')
<!-- internal css -->
@push('styles')
    <style>
        .narrowtxt {
            ...
            <div class="col-xs-12 col-md-offset-1 col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading panel-title">
                        <h1 class="s3-fs-xs-3 text-center" style="color:#782f40;">{{ $single_job->title }} Job Application
                        </h1>
                    </div>
                    <div class="panel-body">
                        <form action="{{ route('apply-job.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="job_post_id" value="{{ $single_job->id }}">
                            <div class="row">
