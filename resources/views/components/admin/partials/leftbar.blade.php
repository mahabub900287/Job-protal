        ...
        <div class="ic-all-nav-list">
            ...
            <div class="ic-nav-list-wrapper">
                ...
                <ul class="ic-nav-list">
                    ...
                    <li class="ic-nav-item-wrapper ">
                        <a class="ic_menubar_item {{ Request::routeIs('admin.users.index') || Request::routeIs('admin.users.create') ? 'active' : '' }}"
                    ...
                    <li class="ic-nav-item-wrapper ">
                        <a class="ic_menubar_item {{ Request::routeIs('admin.job-post.index') || Request::routeIs('admin.job-post.create') || Request::routeIs('admin.job-post.edit') ? 'active' : '' }}"
                            ...
                            <span class="links_name">Job Post</span>
                        </a>
                    </li>
                    <li class="ic-nav-item-wrapper ">
                        <a class="ic_menubar_item {{ Request::routeIs('admin.application.list') ? 'active' : '' }}"
                            ...
                            <span class="links_name">All Application</span>
                        </a>
                    </li>
                </ul>
            </div>
